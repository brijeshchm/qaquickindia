...
class SearchListController extends Controller
{
	...
	{  
		...
		if (!empty($keyword)) {
			...
			return view('client.searchlist', ['clientsList' => $clientsList, 'subcategory' => $subcategory, 'reviewsClientsList' => $reviewsClientsList, 'searchedKW' => ucwords(str_replace("-", " ", $search_kw)), 'searchedInCity' => $searchInCity, 'onlyClients' => $onlyClients, 'keyword' => $keyword, 'city' => $city, 'citiesList' => $cities,'zones'=>$zones]);
		} else {
