               ...
               <div class="col-sm-4 col-md-4 col-xs-12">
                    <div class="business-quickrequestfotm">
                        ...
                        <form class="form-style-9" id="business-form" action="{{url('/business-owners')}}" method="POST">
                            ...
                            <p><input type="text" placeholder="Business/Company Name" class="pull-left" autocomplete="off"
                                    name="business_name" value="{{old('business_name')}}"></p>

                            <p><input type="email" class="field-style pull-left" placeholder="Enter Email" name="email"
                                    value="{{old('email')}}"></p>
                            <p>
                                <style>
                                    @media (max-width: 767px) {
                            ...
                            <!-- <div class="div-code">
                                <div class="drop-number">
                                    <div class="dropdown">
                                        <div class="drop-input-wrapper salary-trend-section">
                                    ...
                                    <div class="quick_arrow">
                                        <p> <input type="tel" class="quick-remove" name="mobile" maxlength="15" value="{{old('mobile')}}" placeholder="Phone No*"
                                                onkeypress="return isNumberKey(event);"> </p>
                                    </div>

                                </div>
                            </div> -->
                            <p><input class="pull-left" type="submit" name="initial_form_submit"
                                    value="Start Your Business"></p>
                        </form>
                    </div>
                </div>

                <div class="col-sm-4 col-md-4 col-xs-12">
                    <img loading="lazy" class="img-responsive" src="<?php    echo asset('client/images/growing.svg'); ?>"
                        style="width: 500px;height: 316px;" alt="growing">
                ...
                <div class="col-sm-4 col-md-4 col-xs-12">
                    ...
                    <div class="banner-steps banner-stepsInternalEven">
                        <div class="bstep1">

                            <img loading="lazy" class="banimgInt" style="height: 37px; width: 37px;"
                                src="{{asset('images/grow-client.png')}}" alt="buyer">
                            <figcaption class="banimghdr" style="display: block; font-size: 20px;"> <span
                                    class="count">{{$clients}}</span> +</figcaption>
                            <figcaption class="banimgDir" style="display: none;"> Grow your Business </figcaption>
                            <p class="banimgInt">Grow Client</p>

                            <p class="banimgDir" style="display: none;">Sell to buyers anytime, anywhere</p>
                        </div>

                        <div class="bstep1">
                            <img loading="lazy" style="width: 47px;" class="banimgInt" src="{{asset('images/Suppliers.png')}}"
                                alt="supplier">

                            <figcaption class="banimghdr" style="display: block; font-size: 20px;"> <span
                                    class="count">8.1</span> K+</figcaption>
                            <p class="banimgInt">Suppliers</p>
                        </div>

                        <div class="bstep1"><img loading="lazy" class="banimgInt" style="width: 37px;"
                                src="{{asset('images/Products-services-grow.png')}}" alt="Products-services-grow">

                            <figcaption class="banimghdr" style="display: block; font-size: 20px;"> <span
                                    class="count">11.3</span> K+</figcaption>
                            <p class="banimgInt">Products &amp; Services</p>
                        </div>
                    </div>
                    ...
                    <div class="banner-steps banner-stepsInternalEven">
                        <div class="bstep1">
                            ...
                            <img loading="lazy" class="banimgInt" style="height: 37px; width: 37px;"
                                src="{{asset('images/keyword-grow.png')}}" alt="prodnserv">
                            <figcaption class="banimghdr" style="display: block; font-size: 20px;"> <span
                                    class="count">{{ $keyword }}</span> +</figcaption>
                            <figcaption class="banimgDir" style="display: none;"> Grow your Business </figcaption>
                            <p class="banimgInt">Keyword</p>

                            <p class="banimgDir" style="display: none;">Sell to buyers anytime, anywhere</p>
                        </div>

                        <div class="bstep1">
                            <img loading="lazy" style="width: 47px;" class="banimgInt" src="{{asset('images/Store-grow.png')}}"
                                alt="prodnserv">

                            <figcaption class="banimghdr" style="display: block; font-size: 20px;"> <span
                                    class="count">21</span>+</figcaption>
                            <p class="banimgInt">Store</p>
                        </div>

                        <div class="bstep1"><img loading="lazy" class="banimgInt" style="width: 37px;"
                                src="{{asset('images/Platform.png')}}" alt="prodnserv">

                            <figcaption class="banimghdr" style="display: block; font-size: 20px;"> <span
                                    class="count">11.3</span> K+</figcaption>
                            <p class="banimgInt">Platform</p>
                        </div>
                    </div>
        ...
        <div class="main-section">
            <div class="features">
                ...
                <div class="feature-item">
                    ...
                    <img loading="lazy" src="img/growbusi.png" style="top: -13px; width: 39px; position: relative; left: 0px;"
                        alt="growbusi">
                    <div class="grow-bus">
                ...
                <div class="feature-item">
                    <img loading="lazy" src="img/zerocast.png" style="top: -13px; width: 39px; position: relative; left: 0px;"
                        alt="zerocast">
                    <div class="grow-bus">
                        <h3>Zero Cost</h3>
                ...
                <div class="feature-item">
                    <img loading="lazy" src="img/mybusiness.png" style="top: -13px; width: 39px; position: relative; left: 0px;"
                        alt="mybusiness">
                    <div class="grow-bus">
            ...
            <div class="features-grid">
                ...
                <div class="feature-card fade-in-left">
                    <div class="feature-icon">
                        <img loading="lazy" src="{{ asset('img/google-maps.png')}}" alt="Google map">
                    </div>
                ...
                <div class="feature-card fade-in" style="transition-delay: 0.2s">
                    <div class="feature-icon">
                        <img loading="lazy" src="{{ asset('img/local-keyword.png')}}" alt="local-keyword">
                ...
                <!-- Feature 3 -->
                <div class="feature-card fade-in-right" style="transition-delay: 0.4s">
                    <div class="feature-icon">
                        <img loading="lazy" src="{{ asset('img/call-form.png')}}" alt="call-form">
                    </div>
                ...
                <div class="feature-card fade-in-left" style="transition-delay: 0.2s">
                    <div class="feature-icon">
                        <img loading="lazy" src="{{ asset('img/lead-capture.png')}}" alt="lead-capture">
                ...
                <div class="feature-card fade-in" style="transition-delay: 0.4s">
                    <div class="feature-icon">
                        ...
                        <img loading="lazy" src="{{ asset('img/review-putation.png')}}" alt="review-putation">
                ...
                <!-- Feature 6 -->
                <div class="feature-card fade-in-right" style="transition-delay: 0.6s">
                    <div class="feature-icon">

                        <img loading="lazy" src="{{ asset('img/citation-building.png')}}" alt="citation-building">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            ...
                            <p>Quick Dials is a comprehensive search platform designed for students, parents, and
                                ...
                                manufacturing, services, and core industries.</p>
                            <ul>
                                ...
                                <li>⚙️ Core Sectors: Covering India’s Eight Core Industries — electricity, steel, refinery
                            ...
                            <ul>
                                <li>If the provided leads are out of your locality or category, we work on the same to
                                    replace it as soon as possible.</li>
                                ...
                                <li>The information about leads will be distributed by SMS on your registered number and
                                    mailing on your registered email id.</li>
                        ...
                        <div class="col-md-6">
                            ...
                            <ul>
                                <li>The work module is very different from others.</li>
                                <li>We follow the conversion module.</li>
                                <li>We provide dual manually verified leads to your business.</li>
                            </ul><br>
                            <p>These aspects make us different from others but there are few more things that make us unique
                                and pops up the priority for you to choose us:</p>
                            <ul>
                                <li> The leads are generated in both ways organic and inorganic</li>
                                <li> We have a co-branding relationship with our own channel partners making us more capable
                                    and worthy to choose.</li>
                                <li> The leads provided by us are all verified twice by our expert counselors, in order to
        ...
        <div class="container">
            ...
            <div class="business-clientBlock">
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 text-center">
                    <img loading="lazy" class="img-responsive" src="<?php echo asset('client/images/business/group.png'); ?>"
                        alt="Leads that Convert to Business" />
                    <span>Leads that Convert to Business</span>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 text-center">
                    <img loading="lazy" class="img-responsive" src="<?php echo asset('client/images/business/profile.png'); ?>"
                        alt="Ready-to-Share Profile" />
                    <span>Ready-to-Share Profile</span>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 text-center">
                    <img loading="lazy" class="img-responsive" src="<?php echo asset('client/images/business/head_phone.png'); ?>"
                                ...
                                <div class="panel-group" id="accordion">
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div id="check1" class="panel-collapse collapse in">
                                            <div class="panel-body">
                                                <p>
                                                    Quick Dials is an extensive search engine for the students, parents, and
                                                    Professionals, Quick Dials Only Deals In Education Sector and helps
                                                    students to grab their right opportunity, and helps business owners to
                                                    grow their business.
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h4 class="check-title">
                                                <a data-toggle="collapse" data-parent="#accordion" href="#check2">
                                                    <span class="acc-icons"></span>Why choose Quick Dials for growing your
                                                    business?
                                                </a>
                                            </h4>
                                        </div>
                                        <div id="check2" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                <p>
                                                    Our Work Module Is Completely Different, we work on the Conversion
                                                    module, and we Provide you Dual Manually Verified Leads to your
                                                    Business.
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div id="check3" class="panel-collapse collapse ">
                                            <div class="panel-body">
                                                <p>
                                                    In case we are unable to fulfill our committed no of leads, we will
                                                    refund your remaining amount.
                                                </p>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h4 class="check-title">
                                                <a data-toggle="collapse" data-parent="#accordion" href="#check4">
                                                    <span class="acc-icons"></span> What happens if I received a lead from
                                                    out of my city/category?
                                                </a>
                                            </h4>
                                        </div>
                                        <div id="check4" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                <p>
                                                    If you get a lead which is either out from your Locality or Category
                                                    Then we will replace it as soon as possible.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="panel-group" id="accordions">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h4 class="check-title">
                                                <a data-toggle="collapse" class="" data-parent="#accordions" href="#check5">
                                                    <span class="acc-icons"></span>How Diffrent your leads quality from
                                                    others?
                                                </a>
                                            </h4>
                                        </div>
                                        <div id="check5" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                <p>
                                                    our leads are dual manually verified by our expert counselors, so no
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h4 class="check-title">
                                                <a data-toggle="collapse" data-parent="#accordions" href="#check6"><span
                                                        class="acc-icons"></span>How do you generate leads?</a>
                                            </h4>
                                        </div>
                                        <div id="check6" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                <p>
                                                    we generate leads organically as well as inorganic leads, and we have
                                                    Our own channels partners
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div id="check7" class="panel-collapse collapse ">
                                            <div class="panel-body">
                                                <p>
                                                    You will receive Leads on your Registered contact no through sms, and
                                                    also on Your registered Email Id.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div id="check8" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                <p>
                                                    For More Info & any Queries, you can Contact Us on +91  75-5943-5943 or
                                                    reach out to us via e-mail @ info@quickdials.com, or list your business
                                                    as free listing, our marketing team Will Contact you Soon.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
...
<!-- 
    <script type="text/javascript">
        ...
        function setupDropdown(modal) {
            ...
            modal.querySelector('.drop-input-wrapper').addEventListener('click', toggleDropdown);
